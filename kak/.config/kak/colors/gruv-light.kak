# Gruvbox light theme for Kakoune

# Color palette
declare-option str black 'rgb:fbf1c7'
declare-option str dark 'rgb:ebdbb2'
declare-option str gray 'rgb:928374'
declare-option str aqua 'rgb:427b58'
declare-option str white 'rgb:282828'
declare-option str blue 'rgb:458588'
declare-option str cyan 'rgb:076678'
declare-option str green 'rgb:79740e'
declare-option str peach 'rgb:d65d0e'
declare-option str orange 'rgb:af3a03'
declare-option str pink 'rgb:b16286'
declare-option str purple 'rgb:8f3f71'
declare-option str red 'rgb:9d0006'
declare-option str yellow 'rgb:b57614'
declare-option str dimgray 'rgb:7c6f64'

declare-option str psel 'rgba:bdae93cc'
declare-option str ssel 'rgba:d5c4a1cc'
