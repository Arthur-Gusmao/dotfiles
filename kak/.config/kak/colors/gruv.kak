...
declare-option str dimmed\_background %opt{gray}
...
set-face global SecondaryCursor "%opt{black},%opt{fg4}+fg"
set-face global PrimaryCursorEol "%opt{black},%opt{fg4}+fg"
set-face global SecondaryCursorEol "%opt{black},%opt{psel}+fg"
set-face global LineNumbers "rgb:7c6f64"
set-face global LineNumberCursor "rgb:fabd2f,rgb:3c3836"
